...
class MySceneGraph {
   ...
   parseScene(sceneNode){
	...
	if (hasAttribute(sceneNode,"root" ))
	   this.root = sceneNode.getAttribute("root");
	else  this.onXMLMinorError("no root attribute");

	if (hasAttribute(sceneNode,"axis_length" ))
	   this.axis_length = sceneNode.getAttribute("axis_length");
